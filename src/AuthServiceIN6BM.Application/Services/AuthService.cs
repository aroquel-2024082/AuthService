...
using AuthServiceIN6BM.Application.Exceptions;
using AuthServiceIN6BM.Application.Extensions;
using AuthServiceIN6BM.Application.Validators;
using AuthServiceIN6BM.Domain.Constants;
using AuthServiceIN6BM.Domain.Entities;
using AuthServiceIN6BM.Domain.Interfaces;
using AuthServiceIN6BM.Domain.Enums;
    ...
    public async Task<RegisterResponseDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        if (registerDto.ProfilePicture != null && registerDto.ProfilePicture.Size > 0)
        {
            ...
            if (!isValid)
            {
                ...
                throw new BusinessException(ErrorCode.INVALID_FILE_FORMAT, errorMessage!);
            }
            ...
            catch (Exception)
            {
                ...
                throw new BusinessException(ErrorCode.IMAGE_UPLOAD_FAILD, "Failed to upload profile image");
            }
        }
        else
        {
